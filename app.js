 ...
 *************************/
const store = {
  tasks: [],         // {id,title,desc,due,priority,status,created}
  issues: [],        // {id,title,desc,status,date}
  wins: [],          // {id,title,desc,date}
  notifications: []  // {id,msg,kind,read,date}
};
 ...
 *************************/
const viewRoot = () => $('#view');
const ROUTES = ['dashboard', 'tasks', 'issues', 'wins', 'notifications'];
